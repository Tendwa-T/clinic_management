          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 ">
            <div className="relative flex h-16 items-center justify-between">
              ...
              {user ? <div className='flex flex-row w-auto justify-between'>
                <h1 className='text-white'>{uname}</h1>
              ...
              </div> : <div className='flex flex-row w-auto'><button className='text-white' onClick={logout}><ArrowLeftOnRectangleIcon className='h-6 w-6' /> <h1>Sign in</h1></button></div>}
